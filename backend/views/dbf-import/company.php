...
<h3> <strong>Загрузить компании .DBF</strong></h3>
...
<button onclick="$.get('save?fileName=<?= $model->fileName ?>&class=CompanyDBF&action=<?=Yii::$app->controller->action->id?>')">Сохранить в базу данных</button>
