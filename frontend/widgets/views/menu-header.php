...
<?php if (isset($services) && !empty($services)): ?>
    <div class="relative group">
        <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
        <a href="<?= Url::to(['/page/14']) ?>" class="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
                ...
                <div class="rounded-lg shadow-xs overflow-hidden">
                    <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                        <?php foreach ($services as $service): ?>
                            <a href="<?= Url::to(['/page/'.$service->id]) ?>" class="-m-3 p-2 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150 text-gray-900 hover:text-blue-700 focus:outline-none focus:text-blue-700">
                                <div class="space-y-1">
                                    <p class="text-base leading-6 font-medium">
                                        <?= $service->title ?>
                                    </p>
