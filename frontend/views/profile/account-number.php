        ...
        foreach ($number->vodomers as $vodomer): ?>
            ...
            if($vodomer->water_metering_first): ?>
                ...
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><b><?= $vodomer->previous_readings_first ?></b>, дата їх передачі <b><?= $vodomer->date_previous_readings ?></b></dd>
                </div>
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm leading-5 font-medium text-gray-500">строк наступної повірки засоба обліку: </dt>
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><?= $vodomer->verification_date ?></dd>
                </div>
            <?php endif; ?>
            <?php
            if($vodomer->water_metering_second): ?>
                ...
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm leading-5 font-medium text-gray-500">Попередні показання засоба обліку води: </dt>
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><b><?= $vodomer->previous_readings_second ?></b>, дата їх передачі <b><?= $vodomer->date_previous_readings ?></b></dd>
                </div>
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            if($vodomer->watering_number): ?>
                ...
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm leading-5 font-medium text-gray-500">Попередні показання засоба обліку води: </dt>
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><b><?= $vodomer->previous_watering_readings ?></b>, дата їх передачі <b><?= $vodomer->date_previous_readings ?></b></dd>
                </div>
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm leading-5 font-medium text-gray-500">Cтрок наступної повірки засоба обліку: </dt>
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><?= $vodomer->verification_date ?></dd>
    ...
    <div>
        <dl>
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"><?= $number->tariff_for_stocks + $number->tariff_for_water?></dd>
            </div>
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
