...
<div class="min-h-screen flex justify-left bg-gray-50 py-2 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        <div>
            ...
            <div>
                <p class="mt-2 text-center text-sm leading-5 text-gray-600">Як вводити дані? Що робити якщо я не знаю номер особового рахунку?</p>
                <p class="mt-2 text-center text-sm leading-5 text-gray-600">Для уточнення правильного номера особового рахунку звертайтеся до відділу збуту КОМУНАЛЬНОГО ПІДПРИЄМСТВА
                "СЄВЄРОДОНЕЦЬКВОДОКАНАЛ".</p>
                <p class="mt-2 text-center text-sm leading-5 text-gray-600">Копійки в сумі оплати вводяться через кому без слів "грн" і т.ін. наприклад 65,54</p>
            </div>
        </div>
        <?php $form = ActiveForm::begin(['id' => 'add-account-form', 'class' => 'mt-8', 'enableAjaxValidation' => true,]); ?>
