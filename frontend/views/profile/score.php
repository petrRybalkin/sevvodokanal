                        ...
                        <ul class="border border-gray-200 rounded-md">
                            <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                                ...
                                <div class="ml-4 flex-shrink-0">
                                    <a href="<?= \yii\helpers\Url::to(['/profile/word', 'id' => Yii::$app->request->get('id')]) ?>" class="font-medium text-indigo-600 hover:text-indigo-500 transition duration-150 ease-in-out">Завантажити в Word</a>
                                </div>
                            </li>
                        </ul>
                    </dd>
